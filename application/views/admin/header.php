...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/admin/'); ?>assets/vendor/css/jquery.dataTables.min.css">
    <link rel="stylesheet" href="<?php echo base_url('assets/admin/'); ?>assets/vendor/css/daterangepicker.css">
            ...
            <div class="col-xxl-6 col-xl-5 col-4 d-flex align-items-center gap-20">
                <div class="main-logo d-lg-block d-none">
                    ...
                    <div class="logo-small">
                        <a href="index.html">
                            <img src="<?php echo base_url('assets/admin/'); ?>assets/images/logo-small.png" alt="Logo">
                        </a>
                    </div>
                </div>
                ...
                <div class="header-right-btns d-flex justify-content-end align-items-center">
                                ...
                                <div class="header-btn-box">
                                    ...
                                    <ul class="message-dropdown dropdown-menu" aria-labelledby="messageDropdown">
                                        <li>
                                            <a href="#" class="d-flex">
                                                <div class="avatar">
                                                    <img src="<?php echo base_url('assets/admin/'); ?>assets/images/avatar.png" alt="image">
                                                </div>
                                                <div class="msg-txt">
                                        ...
                                        <li>
                                            <a href="#" class="d-flex">
                                                <div class="avatar">
                                                    <img src="<?php echo base_url('assets/admin/'); ?>assets/images/avatar-2.png" alt="image">
                                                </div>
                                                <div class="msg-txt">
                                        ...
                                        <li>
                                            <a href="#" class="d-flex">
                                                <div class="avatar">
                                                    <img src="<?php echo base_url('assets/admin/'); ?>assets/images/avatar-3.png" alt="image">
                                                </div>
                                                <div class="msg-txt">
                                ...
                                <div class="header-btn-box">
                                    ...
                                    <ul class="notification-dropdown dropdown-menu" aria-labelledby="notificationDropdown">
                                        ...
                                        <li>
                                            <a href="#" class="d-flex align-items-center">
                                                <div class="avatar">
                                                    <img src="<?php echo base_url('assets/admin/'); ?>assets/images/avatar-4.png" alt="image">
                                                </div>
                                                <div class="notification-txt">
                                        ...
                                        <li>
                                            <a href="#" class="d-flex align-items-center">
                                                <div class="avatar">
                                                    <img src="<?php echo base_url('assets/admin/'); ?>assets/images/avatar-5.png" alt="image">
                                                </div>
                                                <div class="notification-txt">
                                        ...
                                        <li>
                                            <a href="#" class="d-flex align-items-center">
                                                <div class="avatar">
                                                    <img src="<?php echo base_url('assets/admin/'); ?>assets/images/avatar-6.png" alt="image">
                                                </div>
                                                <div class="notification-txt">
                    ...
                    <div class="header-btn-box profile-btn-box">
                        <button class="profile-btn" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="<?php echo base_url('assets/admin/'); ?>assets/images/admin.png" alt="image">
                        </button>
            ...
            <div class="right-sidebar-group">
                ...
                <div>
                    <div class="sidebar-bg-btn-box">
                        ...
                        <button class="sidebar-bg-btn" data-img="<?php echo base_url('assets/admin/'); ?>assets/images/nav-bg-1.jpg"></button>
                        <button class="sidebar-bg-btn" data-img="<?php echo base_url('assets/admin/'); ?>assets/images/nav-bg-2.jpg"></button>
                        <button class="sidebar-bg-btn" data-img="<?php echo base_url('assets/admin/'); ?>assets/images/nav-bg-3.jpg"></button>
                        <button class="sidebar-bg-btn" data-img="<?php echo base_url('assets/admin/'); ?>assets/images/nav-bg-4.jpg"></button>
                    </div>
                </div>
            </div>
            <div class="right-sidebar-group">
                ...
                <div>
                    <div class="main-content-bg-btn-box">
                        ...
                        <button class="main-content-bg-btn" data-img="<?php echo base_url('assets/admin/'); ?>assets/images/main-bg-1.jpg"></button>
                        <button class="main-content-bg-btn" data-img="<?php echo base_url('assets/admin/'); ?>assets/images/main-bg-2.jpg"></button>
                        <button class="main-content-bg-btn" data-img="<?php echo base_url('assets/admin/'); ?>assets/images/main-bg-3.jpg"></button>
                        <button class="main-content-bg-btn" data-img="<?php echo base_url('assets/admin/'); ?>assets/images/main-bg-4.jpg"></button>
                    </div>
                </div>
            </div>
            <div class="right-sidebar-group">
